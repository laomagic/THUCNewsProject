...
parse = argparse.ArgumentParser(description='CNN text Classification')
parse.add_argument('--model', type=str, default='TextCNN',
                   help='choose a model: CNN, RNN, RCNN, RNN_Att, DPCNN, Transformer')
parse.add_argument('--word', default=True, type=bool, help='True for word, False for char')
parse.add_argument('--max_length', default=400, type=int, help='True for word, False for char')
parse.add_argument('--dictionary', default=config.dict_path, type=str, help='dictionary path')
